...
$(document).ready(function(){
    ...
    $.get("/liulan/cookhind/hind.php",{uniqid:localStorage.uniqid,pageid:window.ico,action:1,move:localStorage.move,os:os,mobile:mobile,href:href},function(data){
    console.log(data)});
});
window.onbeforeunload=function(){
    href=window.location.href;
    $.get("/liulan/cookhind/hind.php",{uniqid:localStorage.uniqid,pageid:window.ico,action:2,move:localStorage.move,os:os,mobile:mobile},function(data) {
