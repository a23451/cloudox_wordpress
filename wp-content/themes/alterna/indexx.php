...
?>
	<div id="main" class="container">
    	<div class="row">
            ...
            <?php if($layout != 1) { ?> 
            <aside class="alterna-col col-lg-3 col-md-4 col-sm-4 alterna-<?php echo $layout_class;?>"><?php echo $layout_class;?><?php generated_dynamic_sidebar($sidebar_name); ?></aside>
            <?php } ?>
